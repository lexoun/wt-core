...
}elseif(!empty($_COOKIE["cookie_user"]) && !empty($_COOKIE["cookie_pass"])){
...
$pagetitle = 'Administrační rozhraní';
...
<div class="login-container">
    ...
    <div class="login-header login-caret">
        ...
        <div class="login-content">
            ...
            <p class="description">administrační rozhraní společnosti Wellness Trade</p>
            ...
            <form method="post" role="form" id="form_login">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" name="username" id="username" placeholder="Email" autocomplete="off"  style="background: transparent !important;"/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" name="password" id="password" placeholder="Heslo" autocomplete="off" style="background: transparent !important;" />
                    </div>
...
<div class="footer-logos">
    ...
    <a href="http://www.spahouse.cz"><img src="<?= $home ?>/admin/assets/images/spahouse-logo-footer.png"></a>
    <a href="https://www.saunahouse.cz"><img src="<?= $home ?>/admin/assets/images/saunahouse-footlogo.png"  style="margin-bottom: -6px;"></a>
    <a href="https://www.virivka.cz"><img src="<?= $home ?>/admin/assets/images/virivka-footlogo.png"></a>
    <a href="http://www.iquespa.cz" style="margin-right: 0px;"><img src="<?= $home ?>/admin/assets/images/ique-footlogo.png"></a>
