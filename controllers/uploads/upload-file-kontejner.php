...
$storeFolder = $_SERVER['DOCUMENT_ROOT'] . '/admin/data/containers/' . $_REQUEST['link'] ."/" .$_REQUEST['id'] . "/" . $_REQUEST['type']; //2
...
if (!empty($_FILES)) {
    ...
    $im->writeImage($_SERVER['DOCUMENT_ROOT'] . '/admin/data/containers/' . $_REQUEST['link'] ."/" .$_REQUEST['id'] . "/" . $_REQUEST['type'] . '/small_' . $_FILES['file']['name']);

    $targetFile = $_SERVER['DOCUMENT_ROOT'] . '/admin/data/containers/' . $_REQUEST['link'] ."/" .$_REQUEST['id'] . "/" . $_REQUEST['type'] . '/' . $_FILES['file']['name']; //5
