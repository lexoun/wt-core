...
if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'technical') {

    $storeFolder = $_SERVER['DOCUMENT_ROOT'] . '/data/clients/pictures/technical/' . $getclient['secretstring'];

} elseif (isset($_REQUEST['type']) && $_REQUEST['type'] == 'realization') {

    $storeFolder = $_SERVER['DOCUMENT_ROOT'] . '/data/clients/pictures/realization/' . $getclient['secretstring'];
