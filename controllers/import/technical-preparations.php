...
<li>Přívod CYKY 5 x 2,5mm, jistič C16A + chránič</li>
 ...
 if (strpos($subject, 'Pergola') !== false) {

    $opening_text = '<p style="margin: 0 0 16px;">Dobrý den,</p>
    
    <p style="margin: 0 0 16px;">v příloze zasíláme požadovanou kompletní stavební přípravu pro ' . $title . '.</p>
    
    '.$additional_info.'
    
     <p style="margin: 0 0 16px;">děkujeme za zájem o naše služby a stažení stavební přípravy. V případě jakýchkoli otázek či nejasností k pergoly či stavební přípravě nás prosím neváhejte kdykoli kontaktovat</p>
     <p style="margin: 0 0 16px;">Technické odd.:  777 624 475</p>
     <p style="margin: 0 0 16px;">Obchodní odd.:  774 44 33 14</p>
    ...
    '.$additional_info.'
     ...
     <p style="margin: 0 0 16px;">V případě, že nám zašlete situační nákres (stačí od ruky). Vyznačíme Vám ideální místo pro vývod kabelu.</p>
...
if(file_exists($_SERVER['DOCUMENT_ROOT'] . '/admin/data/demands/documents/' . $title . ' - Stavební příprava.pdf')){
    ...
    $subject = 'Stavební příprava ' . $title;
