...
$soldHottubsQuery = $mysqli->query("
    SELECT COUNT(*), DATE_FORMAT(datetime, '%d. %m. %Y'), type FROM demands_mails_history
    WHERE type = 'Návštěva - neplánovaná' OR type = 'Návštěva - plánovaná'
    GROUP BY DATE_FORMAT(datetime, '%d. %m. %Y'), type
