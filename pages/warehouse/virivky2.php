...
if (isset($_REQUEST['action']) && $_REQUEST['action'] == "remove") {
    ...
    header('location: https://www.wellnesstrade.cz/admin/pages/warehouse/virivky?id=' . $_REQUEST['id'] . '&success=remove');
    exit;
}
...
if (isset($_REQUEST['action']) && $_REQUEST['action'] == "demandchange") {
    ...
    header('location: https://www.wellnesstrade.cz/admin/pages/warehouse/virivky?id=' . $_REQUEST['id'] . '&changedemand=success');
    exit;
}
...
if (isset($search) && $search != "") { ?>
            ...
            <div class="row">
                <div class="col-md-8 col-sm-7">
                    <h2>Na hledaný výraz <i><u>"<?= $search ?>"</u></i> odpovídají tyto vířivky:</h2>
                </div>
