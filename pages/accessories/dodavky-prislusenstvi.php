...
$supply_query = $mysqli->query("SELECT *, DATE_FORMAT(date, '%d. %m. %Y') as date_formated FROM products_supply ORDER BY id DESC limit " . $s_pocet . "," . $perpage) or die($mysqli->error);
...
<table class="table table-bordered table-striped datatable dataTable">
	<thead> <tr> <th width="200px">Objednávka</th><th width="120px" class="text-center">Datum</th>
		<th style="width: 600px;">Zakoupeno</th> <th>Doručení</th> <th class="text-center">Cena</th> <th width="220px" class="text-center">Akce</th></tr> </thead>
