            ...
            <div class="panel-body">
                <div class="form-group <?php if (isset($_REQUEST['client']) && $_REQUEST['client'] == 'not_found') {echo 'validate-has-error';}?>" style="margin-top: 20px;">
                    ...
                    while ($customer = mysqli_fetch_assoc($clientsQuery)) {
                        ...
                        array_push($clientsArray, $current_array);
			...
			<div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6" style="padding: 0;">
                                <label class="col-sm-12 control-label" style="text-align: center; margin-bottom: 10px;">Druh doručení ~ <span class="delivery_label">CZ</span></label>
                                <div class="col-sm-12">
                ...
                WHEN shop_method_id like 'free_shipping' THEN 3
                        ELSE 4 END, name");
                                            ...
                                            while ($delivery_method = mysqli_fetch_array($delivery_methods_query)) {
                                                ...
                                                ?><option value="<?= $delivery_method['link_name'] ?>"><?= $delivery_method['shop_title'] ?></option><?php
                ...
                WHEN shop_method_id like 'free_shipping' THEN 3
                        ELSE 4 END, name");
                            ...
                            <?php
                            $payment_methods_query = $mysqli->query("SELECT * FROM shops_payment_methods ORDER BY name");
                            ...
                            <div class="col-sm-6" style="padding: 0;">
                                ...
                                <div class="col-sm-12">
                                    <select id="payment" name="payment" class="selectboxit">
                                        <?php while ($payment_method = mysqli_fetch_array($payment_methods_query)) { ?><option value="<?= $payment_method['link_name'] ?>"><?= ucfirst($payment_method['pay_text']) ?></option><?php } ?>
                                    </select>
                                </div>
...
//                        echo $branch->getId() . ' ' . $branch->getName() . PHP_EOL;
                        ...
                        <div class="form-group ulozenka" style="margin-top: 10px; margin-bottom: 24px; display: none;">
...
//                        echo $branch->getId() . ' ' . $branch->getName() . PHP_EOL;
                        ...
                        <div class="form-group ceska_posta" style="margin-top: 10px; margin-bottom: 24px; display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="radio" style="width: 100px;float: left;">
                                    <label>
                                        <input type="radio" name="vat" value="12">12%
                                    </label>
                                </div>
                                <div class="radio" style="width: 100px; float: left;">
                                    <label>
